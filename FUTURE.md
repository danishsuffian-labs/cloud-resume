...
Preserve the current visual design, including the circular portrait and About layout approved by the owner.

Browser review is required before calling the frontend fully verified and is tracked only in `PLAN.md` to avoid duplicate completion checklists.
